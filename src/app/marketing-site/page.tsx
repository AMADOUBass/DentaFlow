          ...
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-10">
            ...
            <div className="animate-in fade-in slide-in-from-top-4 duration-1000">
              <div className="inline-flex items-center gap-2 p-1 pr-4 rounded-full bg-slate-900/5 border border-slate-900/10 backdrop-blur-sm group cursor-pointer hover:border-primary/30 transition-all">
                <span className="bg-primary text-white text-[9px] font-black px-2.5 py-0.5 rounded-full uppercase tracking-widest">{t.common.new}</span>
                <span className="text-xs font-bold text-slate-600 group-hover:text-primary transition-colors flex items-center gap-1">
                  {t.home.badge_ai_booking} <ChevronRight className="h-3 w-3" />
                </span>
              </div>
            </div>
            ...
            <div className="pt-16 opacity-50 grayscale animate-in fade-in duration-1000 delay-1000">
               <p className="text-[9px] font-black uppercase tracking-[0.3em] text-slate-400 mb-6">{t.home.powered_by}</p>
      ...
      <section id="features" className="py-24 bg-slate-50/50 border-y border-slate-100 relative overflow-hidden">
        <div className="container mx-auto px-4 relative">
          <div className="max-w-2xl mb-20">
             <Badge className="bg-primary/10 text-primary border-none hover:bg-primary/20 px-3 py-0.5 mb-4 text-[10px] font-black uppercase tracking-widest">{t.features.integrated_badge}</Badge>
                ...
                <div className="absolute bottom-0 right-0 w-[60%] h-[60%] bg-white rounded-tl-[3rem] border-t border-l border-slate-100 shadow-2xl overflow-hidden p-4 group-hover:translate-x-2 group-hover:-translate-y-2 transition-transform">
                   <div className="w-full h-full rounded-2xl bg-slate-50 p-4 space-y-4">
                      <div className="flex justify-between items-center">
                         <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest">{t.features.dashboard_today}</div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                         <div className="bg-white p-3 rounded-xl shadow-sm border border-slate-100 space-y-1">
                            ...
                            <p className="text-[8px] text-primary font-bold">14:00 - {t.solutions_preview.card_care}</p>
                         </div>
                         <div className="bg-white p-3 rounded-xl shadow-sm border border-slate-100 space-y-1">
                            <p className="text-[10px] font-black text-slate-900">Dr. Bass</p>
                            <p className="text-[8px] text-primary font-bold">15:30 - {t.solutions_preview.card_cleaning}</p>
                         </div>
                      </div>
                      <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex items-center gap-3">
                         ...
                         <div className="flex-1">
                            ...
                            <p className="text-[8px] font-bold text-slate-400 mt-1">{t.features.dashboard_capacity}: 85%</p>
                         </div>
                      </div>
                   </div>
                </div>
             ...
             <div className="md:col-span-4 md:row-span-2 bento-item bg-slate-900 text-white border-none group p-10">
                ...
                <div className="relative z-10 flex flex-col h-full justify-between">
                   ...
                   <div className="space-y-3">
                      ...
                      <div className="pt-4">
                         <Button variant="link" className="text-primary font-black p-0 uppercase tracking-widest text-[9px] hover:text-white transition-colors">{t.features.law25_cta} <ArrowRight className="h-3 w-3 ml-2" /></Button>
                      </div>
                   </div>
                </div>
             </div>
               ...
               <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  <div className="space-y-8">
                     <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-primary text-[10px] font-black uppercase tracking-widest">
                        {t.solutions_preview.badge}
                     </div>
                     <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tighter leading-tight">
                        {t.solutions_preview.title_part1} <span className="italic text-primary">{t.solutions_preview.title_accent}</span>
                     </h2>
                     <p className="text-lg text-slate-400 font-medium max-w-lg leading-relaxed">
                        {t.solutions_preview.desc}
                     </p>
                     <div className="flex items-center gap-8 pt-2">
                        <div className="space-y-1">
                           <p className="text-3xl font-black text-white">45%</p>
                           <p className="text-[9px] text-slate-500 uppercase font-bold tracking-widest">{t.solutions_preview.stats_errors}</p>
                        </div>
                        <div className="w-px h-10 bg-white/10" />
                        <div className="space-y-1">
                           <p className="text-3xl font-black text-primary">+2h</p>
                           <p className="text-[9px] text-slate-500 uppercase font-bold tracking-widest">{t.solutions_preview.stats_saved}</p>
                        </div>
                     </div>
                  </div>
                              ...
                              <div className="space-y-4">
                                 <div className="flex gap-2">
                                    <div className="w-1/2 bg-white/5 rounded-xl border border-white/5 p-3 space-y-1.5">
                                       <p className="text-[8px] text-slate-500 font-black uppercase">{t.solutions_preview.card_status}</p>
                                       <p className="text-[10px] text-emerald-400 font-bold">{t.solutions_preview.card_confirmed}</p>
                                    </div>
                                    <div className="w-1/2 bg-white/5 rounded-xl border border-white/5 p-3 space-y-1.5">
                                       <p className="text-[8px] text-slate-500 font-black uppercase">{t.solutions_preview.card_care}</p>
                                       <p className="text-[10px] text-white font-bold">{t.solutions_preview.card_cleaning}</p>
                                    </div>
                                 </div>
                                 <div className="bg-primary/10 rounded-xl border border-primary/20 p-4 space-y-3">
                                    <p className="text-[10px] text-white font-black">{t.solutions_preview.card_notes}</p>
                                    <p className="text-[8px] text-slate-400 leading-relaxed font-medium">{t.solutions_preview.card_notes_text}</p>
                                 </div>
                              </div>
                           </div>
                           <div className="flex justify-between items-center pt-4">
                              <p className="text-[10px] text-slate-500 font-bold italic">{t.solutions_preview.signed}</p>
                              <div className="w-20 h-8 bg-primary rounded-lg flex items-center justify-center text-[9px] font-black text-white uppercase tracking-widest">{t.solutions_preview.save}</div>
                           </div>
                        </div>
                     </div>
                  </div>
      ...
      <section id="pricing" className="py-24 bg-white border-y border-slate-100">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mb-16">
            <Badge className="bg-primary/10 text-primary border-none hover:bg-primary/20 px-3 py-0.5 mb-4 text-[10px] font-black uppercase tracking-widest">{t.pricing_preview.badge}</Badge>
          ...
          <div className="grid lg:grid-cols-3 gap-6 max-w-5xl">
            ...
            <div className="p-8 rounded-[2rem] border border-slate-200 bg-white space-y-6 hover:border-primary/20 hover:shadow-lg transition-all duration-300">
              ...
              <I18nLink href="/pricing"><Button variant="outline" className="w-full h-11 rounded-xl border-2 font-black text-sm">{t.pricing_page.plans.essentiel.cta}</Button></I18nLink>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative p-8 rounded-[2rem] border-2 border-primary bg-white space-y-6 shadow-xl shadow-primary/15">
                <div className="absolute top-0 right-8 -translate-y-1/2 bg-primary text-white text-[9px] font-black px-3 py-1 rounded-full uppercase tracking-[0.2em]">{t.pricing_preview.popular}</div>
                <div className="flex items-center gap-3">
                ...
                <I18nLink href="/register"><Button className="w-full h-11 rounded-xl bg-slate-900 text-white font-black text-sm shadow-lg hover:bg-slate-800 active:scale-95 transition-all">{t.pricing_page.plans.complet.cta}</Button></I18nLink>
              </div>
            </div>
            ...
            <div className="p-8 rounded-[2rem] border border-slate-200 bg-white space-y-6 hover:border-amber-200 hover:shadow-lg transition-all duration-300">
              ...
              <I18nLink href="/pricing"><Button variant="outline" className="w-full h-11 rounded-xl border-2 font-black text-sm hover:border-amber-300 hover:text-amber-600 transition-all">{t.pricing_page.plans.premium.cta}</Button></I18nLink>
            </div>
          </div>
          ...
          <div className="mt-10 max-w-5xl">
            <I18nLink href="/pricing" className="inline-flex items-center gap-2 text-sm font-black text-primary hover:gap-3 transition-all">
              {t.pricing_preview.compare} <ArrowRight className="h-4 w-4" />
            </I18nLink>
          </div>
        </div>
      </section>
